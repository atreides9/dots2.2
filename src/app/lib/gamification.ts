...
export const READING_LEVELS: ReadingLevel[] = [
  {
    ...
    max: 5,
    color: '#736f72',
    gradient: 'linear-gradient(135deg, #736f72 0%, #736f72 100%)',
    icon: '🌱',
    emoji: '🌱',
    description: '지식의 씨앗을 심는 중',
    message: '첫 글을 저장하며 여정이 시작됩니다',
    bgPattern: 'radial-gradient(circle at 20% 50%, rgba(115, 111, 114, 0.1) 0%, transparent 50%)',
    particleColor: '#736f72',
  },
  {
    level: 2,
    name: '새싹 단계',
