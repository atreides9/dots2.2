      ...
      >
            ...
            >
              ...
              <AnimatePresence>
                {isHovered && !isSelected && (
                  ...
                  >
                    <div className="bg-[#24262B] border border-[rgba(115,111,114,0.25)] rounded-lg px-3 py-2 shadow-xl">
        ...
        <AnimatePresence>
          {selectedTopic && (
            ...
            >
              <div className="bg-[#24262B]/95 backdrop-blur-sm border border-[rgba(115,111,114,0.2)] rounded-xl px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
